...
async def not_chat(_, m: Message):
    if m.from_user is not None and m.from_user.id in Config.SUDO:
        ...
        buttons = [
            [
                InlineKeyboardButton('⚡️Make Own Bot', url='https://t.me/joinchat/MnPFCkvcDjZCbjE09lngIw'),
                InlineKeyboardButton('🧩 Join Here', url='https://t.me/joinchat/MnPFCkvcDjZCbjE09lngIw'),
            ]
            ]
